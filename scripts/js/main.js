...
(function ($) {
	...
	var templateFunctions = {
		...
		/** Site Notification */
		siteNotification: function siteNotification() {
		...
		/** Site Preloader */
		sitePreloader: function sitePreloader() {
		...
		/** Site Overlay */
		siteOverlay: function siteOverlay() {
		...
		/** Grid Functions */
		gridFunctions: function gridFunctions() {

			var init = {

				/** Grid Item Filtration **/
				gridFiltration: function gridFiltration() {
		...
		/** Flickity Carousel */
		flickityCarousel: function flickityCarousel() {
		...
		/** Twitter Carousel */
		twitterCarousel: function twitterCarousel() {
		...
		/** Site Transitions */
		siteTransitions: function siteTransitions() {
		...
		/** Elementor Fix */
		elementorFix: function elementorFix() {
