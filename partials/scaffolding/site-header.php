    ...
    if (!$is_custom_header) {
        switch ($header_style) {
            ...
            default:
                $header_left_elements = [['element'  => 'logo', 'visibility' => 'both']];
                $header_center_elements = '';
                $header_right_elements = [['element'  => 'primary-menu', 'visibility' => 'desktop'], ['element'  => 'secondary-menu', 'visibility' => 'desktop'], ['element'  => 'search-icon', 'visibility' => 'both'], ['element'  => 'hamburger-icon', 'visibility' => 'mobile']];
        }
    } else {
