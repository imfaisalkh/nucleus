...
?>
<a id="site-logo"  data-visibility="<?php echo esc_attr(isset($element['visibility']) ? $element['visibility'] : 'desktop'); ?>" href="<?php echo esc_url( home_url('/') ); ?>" class="custom-logo-link element" rel="home" itemprop="url">
    <?php if ($site_logo) { ?>
