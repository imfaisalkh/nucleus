<div class="no-content">
	...
	<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
		<p><?php printf( wp_kses( __( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', '_nucleus' ), 'general' ), esc_url( admin_url( 'post-new.php' ) ) ); ?></p>
	<?php elseif ( is_page_template( 'template-portfolio.php' ) && current_user_can( 'publish_posts' ) ) : ?>
		<p><?php printf( wp_kses( __( 'Ready to publish your first project? <a href="%1$s">Get started here</a>.', '_nucleus' ), 'general' ), esc_url( admin_url( 'post-new.php?post_type=portfolio' ) ) ); ?></p>
